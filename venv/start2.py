...
def main():
    ...
    text2 = font2.render("남편~ 이것 좀 봐!", True, (255, 255, 255))
...
def next1():
    ...
    text4 = font2.render("뭔데 그래?", True, (255, 255, 255))
...
def next2():
    ...
    text6 = font2.render("이 친구들 춤도 잘 추고 완전 멋있다. 그치?", True, (255, 255, 255))
...
def next3():
    ...
    text8 = font2.render("응.... 그러네.", True, (255, 255, 255))
...
def next4():
    ...
    text10 = font2.render("남편 혹시 콘서트 가고 싶은 생각 없어? ㅎㅎ", True, (255, 255, 255))
